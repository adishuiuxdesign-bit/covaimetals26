...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "COVAIMETALS — PVC Ball Valves, Taps & Pipe Fittings in Coimbatore" },
      ...
      { property: "og:title", content: "COVAIMETALS — PVC Ball Valves & Pipe Fittings, Coimbatore" },
      { property: "og:description", content: "Quality PVC & UPVC valves, taps, foot valves and union fittings — all sizes in stock at our Ganapathy store." },
