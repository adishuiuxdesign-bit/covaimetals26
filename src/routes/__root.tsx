...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "COVAIMETALS — PVC Ball Valves, Taps & Pipe Fittings in Coimbatore" },
      ...
      { name: "twitter:title", content: "COVAIMETALS — PVC Ball Valves, Taps & Pipe Fittings in Coimbatore" },
